...
UV_BIN_DIR="$TOOLCHAIN_ROOT/stack/uv/$PIN_UV/bin"
UV_TOOLS="$TOOLCHAIN_ROOT/uv-tools"
...
echo "export UV_TOOL_DIR=\"$UV_TOOLS\""
echo "export UV_TOOL_BIN_DIR=\"$UV_TOOLS/bin\""
echo "unset GOROOT"
echo "export GOCACHE=\"$GOCACHE_PIN\""
echo "export GOMODCACHE=\"$GOMODCACHE_PIN\""
echo "export PATH=\"$MISE_DATA/shims:$MISE_BIN_DIR:$UV_TOOLS/bin:$UV_BIN_DIR:\$PATH\""
